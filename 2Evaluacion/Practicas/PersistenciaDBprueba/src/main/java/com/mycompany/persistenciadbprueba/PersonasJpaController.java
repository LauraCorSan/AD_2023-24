...
import com.mycompany.persistenciadbprueba.exceptions.NonexistentEntityException;
import com.mycompany.persistenciadbprueba.exceptions.PreexistingEntityException;
...
public class PersonasJpaController implements Serializable {
    ...
    public void create(Personas personas) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPersonas(personas.getId()) != null) {
