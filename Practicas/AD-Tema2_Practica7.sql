...
/*Se desea guardar los nombres de los hijos de empleados, para esto se puede usar una colección.
Id	nombre	apellidos	hijos
1	Francisco	Pérez	(Luis, Ursula)
2	Esperanza 	Jiménez	(José, Carlos,Pedro)*/


/*1. Crear un tipo colección llamado colec_hijos que tendrá como máximo grupos de 10 valores y además serán de máximo 
30 caracteres.*/
...
--Llamo a la tabla trabajador porque el typo empleado existe de anteriores practicas
...
--8. Crea un bloque PL para visualizar el nombre del empleado y el nombre de todos sus hijos. La salida debe ser así:
/*IDEMP: 1 NOMBRE: Francisco APELLIDO: Perez
El hijo: 1 se llama: luis
El hijo: 2 se llama: ursula
IDEMP: 2 NOMBRE: Esperanza APELLIDO: Jimenez
El hijo: 1 se llama: jose
El hijo: 2 se llama: carlos
El hijo: 3 se llama: pedro*/
