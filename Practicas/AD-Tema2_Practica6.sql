-- TEMA 2 PRACTICA 6
/*1. Crear el tipo “empleado” con los atributos “Rut varchar(10)”, “Nombre varchar(10)”, “Cargo varchar(9)”, 
“fechaIng date”, “sueldo number(9)”, “somision number (9)”, y “anticipo number (9)”, la función “sueldo_liquido”, 
que devuelve un number, y el procedimiento “aumento_sueldo”  que recibe como parámetro el aumento (number).*/
...
/*2. Crear el body para dicho tipo desarrollando la función y el procedimiento. El sueldo líquido se calculará  
como “(sueldo +comisión )- anticipo”, y el aumento de sueldo se calculará como “sueldo+aumento”.*/
...
/*7. Crear un bloque PL/SQL para listar el sueldo líquido del empleado rut=1. Aumentarle el sueldo con 400 euros. 
Listar el sueldo aumentado. La salida será como sigue:
...
select * from empleados; --esta implementado en el ej7
