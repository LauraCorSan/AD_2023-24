...
/*1. A partir del tipo_cubo creado en la práctica 3, añadir un nuevo método (procedimiento) de tipo static llamado 
nuevoCubo con los atributos V_largo INTEGER, V_ancho INTEGER y V_alto INTEGER.*/

DROP TABLE CUBOS; --borramos porque no deja modificar un tipo si una tabla depende de el
