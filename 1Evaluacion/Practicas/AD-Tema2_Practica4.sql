...
/*Se desea modelar un objeto triángulo para almacenar sus características (la base y la altura), y almacenar en la BBDD 
cientos de triángulos pudiendo calcular el área de cada triángulo. Se podría crear el siguiente esquema:*/

/* A. Un tipo llamado tipo_triángulo con los atributos base number, altura number y una función llamada  area return number. 
Recordar que el área de un triángulo se calcula como (base*altura)/2.*/
...
/*C. Crear una tabla relacional llamada triangulos para almacenar los triángulos, con las columnas Id number y triangulo 
de tipo_triangulo.*/
...
/*F. Crear un bloque PL/SQL para recorrer la tabla triángulos e invocar al método área, de forma que en el resultado 
obtengamos esto:
