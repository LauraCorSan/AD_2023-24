...
/*Se desea guardar los nombres de los departamentos, para esto puede usar una colección.
...
/*1. Crear un tipo colección llamado colec_tipo_nombres_dept que tendrá como máximo grupos de 7 valores y además serán 
...
/*5. Crea un bloque PL en el que declararemos una variable de tipo colección y le asignaremos los siguientes valores
a la colección (benefits, advertising, contracting, executive, marketing). Actualizará los departamentos de la 
región de Europa con los inicializados anteriormente. Recorre la colección para visualizar todos los nombres de 
los departamentos de la región de Europa. Con una salida como la siguiente:
departamentos=benefits
departamentos=advertising
departamentos=contracting
departamentos=executive
...
/*6. Crear otro bloque PL para visualizar la región y sus departamentos para todas las regiones ( necesitarás un cursor)
con una salida como la siguiente:
Region: Europa
departamento (1)benefits
departamento (2)advertising
departamento (3)contracting
departamento (4)executive
departamento (5)marketing
Region: America
departamento (1)sales
departamento (2)finances
departamento (3)chipping
Region: Asia
departamento (1)finances
departamento (2)payroll
departamento (3)shipping
departamento (4)sales*/
